...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class VicoLibraryAccessors extends SubDependencyFactory {
        ...
        public VicoLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for compose (com.patrykandpatrick.vico:compose-m3)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCompose() {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: paparazzi (1.3.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class FirebaseVersionAccessors extends VersionFactory  {
        ...
        private final FirebasePerfVersionAccessors vaccForFirebasePerfVersionAccessors = new FirebasePerfVersionAccessors(providers, config);
        ...
        /**
         * Returns the group of versions at versions.firebase.perf
         */
        public FirebasePerfVersionAccessors getPerf() {
            return vaccForFirebasePerfVersionAccessors;
        }
    ...
    public static class FirebaseCrashlyticsVersionAccessors extends VersionFactory  {
        ...
        public FirebaseCrashlyticsVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: firebase.crashlytics.gradle (2.9.9)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class FirebasePerfVersionAccessors extends VersionFactory  {

        public FirebasePerfVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: firebase.perf.plugin (1.4.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getPlugin() { return getVersion("firebase.perf.plugin"); }
    ...
    public static class HiltVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        public Provider<String> asProvider() { return getVersion("hilt"); }
            ...
            /**
             * Returns the version associated to this alias: hilt.work (1.1.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class RetrofitVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
         ...
         */
        public RetrofitSerializationVersionAccessors getSerialization() {
            return vaccForRetrofitSerializationVersionAccessors;
        }
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        public PluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Creates a plugin provider for paparazzi to the plugin id 'app.cash.paparazzi'
             * This plugin was declared in catalog libs.versions.toml
             */
